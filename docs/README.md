...
Technical documentation for working on the toolkit. End-user usage lives
in the top-level [README](../README.md).

| Topic | Doc |
|---|---|
| How the pieces fit together, container lifecycle, threading model | [architecture.md](architecture.md) |
